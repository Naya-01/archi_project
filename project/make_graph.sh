...
make -C "./server_implementation" run_simd128 &
...
make -C "./server_implementation" run_simd256 &
rm -rf results
...
# make -C "./server_implementation" run_simd512 &
# rm -rf results
...
make -C "./server_implementation" run_simd_best &
rm -rf results
